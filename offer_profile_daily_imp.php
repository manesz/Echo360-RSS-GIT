...
<?php
$offerCode = @$_REQUEST['id'];
$startDatePicker = @$_REQUEST['startDatePicker'];
    ...
    <div class="row">
        <div class="col-sm-12 main">
            <?php if(!empty($getOfferImpToDay)):?>
                <div id="graphOfferImpToDay" class="col-lg-12" style="min-width: 310px; height: 400px; margin: 0 auto"></div>
