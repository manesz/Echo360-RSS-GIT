...
class accountClass {
    ...
    public function getAccountListAll(){
        $conn = $this->connClass->sqlsrv_connection();
        $sql = "{CALL [RSS_getAccountListAll]}";
        $query = sqlsrv_query($conn, $sql) or die( print_r( sqlsrv_errors(), true));
        while($result = sqlsrv_fetch_array($query)):
            $arrResult[] = array(
                ...
                , $result[9] // gender
                , $result[10] // status
                , $result[11] // income range
                , $result[12] // occupation
                , $result[13] // education
                , $result[14] // marital status
                , $result[15] // children flag
                , $result[16] // YOB child(1)
                , $result[17] // YOB child(2)
                , $result[18] // YOB child(3)
                , $result[19] // dummy flag
                , $result[20] // email verify flag
                , $result[21] // identify number
                , $result[22] // first quota
                , $result[23] // First_Quota_Freq_Val
                , $result[24] // First_Quota_Dur_Val
                , $result[25] // Channel
                , $result[26] // registration dttm
                , $result[27] // activation dttm
                , $result[28] // first call dttm
                , $result[29] // first mobile number
                , $result[30] // trial used flag
                , $result[31] // trial used dttm
                , $result[32] // interact profile dttm
                , $result[33] // staff no
                , $result[34] // person income range
                , $result[35] // zipcode
                , $result[36] // areacode
                , $result[37] // create by
                , $result[38] // created dttm
                , $result[39] // update by
                , $result[40] // updateed dttm
            );
        endwhile;
        return $arrResult;
    }//END: getAccountListAll()
